			...
			<div id="navbar" class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					<li class="dropdown active">
						<a href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Pelanggan
						...
						<ul class="dropdown-menu" aria-labelledby="dLabel">
							...
							<li class="divider"></li>
							<li>
								<a href="{{url('info')}}">Informasi Penerbangan</a>
							</li>
						</ul>
					</li>
					<li class="dropdown active">
						<a href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Petugas
						<span class="caret"></span></a>
						<ul class="dropdown-menu" aria-labelledby="dLabel">
							<li>
					...
					<li class="dropdown active">
						...
						<ul class="dropdown-menu" aria-labelledby="dLabel">
							...
							<li class="divider"></li>
							<li>
								<a href="{{url('rute')}}">Rute</a>
							</li>
							<li>
								<a href="{{url('penerbangan')}}">Penerbangan</a>
							</li>
						</ul>
					</li>					
				</ul>
